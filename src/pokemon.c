...
static const enum NationalDexOrder sKantoToNationalOrder[KANTO_DEX_COUNT] =
{
    ...
    KANTO_TO_NATIONAL(VOHOODU),
    KANTO_TO_NATIONAL(TZARKARTZ),
    ...
    KANTO_TO_NATIONAL(FORFOWLD),
    KANTO_TO_NATIONAL(FOWLNTOM),
    ...
    KANTO_TO_NATIONAL(PORYGONX),
    KANTO_TO_NATIONAL(PORYGONQ),
    ...
    KANTO_TO_NATIONAL(MISSINGNO1),
    KANTO_TO_NATIONAL(MISSINGNO2),
    KANTO_TO_NATIONAL(MISSINGNO3),
    KANTO_TO_NATIONAL(MISSINGNO4),
    KANTO_TO_NATIONAL(MISSINGNO5),
};
