...
#if defined(FIRERED)
    { COMPOUND_STRING("ABRA{CLEAR_TO 0x55}{FONT_SMALL} 1 COINS") },
    { COMPOUND_STRING("CLEFAIRY{CLEAR_TO 0x55}{FONT_SMALL} 10 COINS") },
    { COMPOUND_STRING("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 100 COINS") },
    { COMPOUND_STRING("SCYTHER{CLEAR_TO 0x4B}{FONT_SMALL} 150 COINS") },
    { COMPOUND_STRING("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 200 COINS") },
#else
    { COMPOUND_STRING("ABRA{CLEAR_TO 0x55}{FONT_SMALL} 1 COINS") },
    { COMPOUND_STRING("CLEFAIRY{CLEAR_TO 0x55}{FONT_SMALL} 10 COINS") },
    { COMPOUND_STRING("PINSIR{CLEAR_TO 0x4B}{FONT_SMALL} 100 COINS") },
    { COMPOUND_STRING("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 150 COINS") },
    { COMPOUND_STRING("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 200 COINS") },
#endif
    { sText_NoThanks }
};
...
static const struct MenuAction sMultichoiceList_GameCornerTMPrizes[] = {
    { COMPOUND_STRING("TM13{CLEAR_TO 0x48}{FONT_SMALL}200 COINS") },
    { COMPOUND_STRING("TM23{CLEAR_TO 0x48}{FONT_SMALL}200 COINS") },
    { COMPOUND_STRING("TM24{CLEAR_TO 0x48}{FONT_SMALL}200 COINS") },
    { COMPOUND_STRING("TM30{CLEAR_TO 0x48}{FONT_SMALL}200 COINS") },
    { COMPOUND_STRING("TM35{CLEAR_TO 0x48}{FONT_SMALL}200 COINS") },
    { sText_NoThanks }
};

static const struct MenuAction sMultichoiceList_GameCornerBattleItemPrizes[] = {
    { COMPOUND_STRING("SMOKE BALL{CLEAR_TO 0x5A}{FONT_SMALL}10 COINS") },
    { COMPOUND_STRING("MIRACLE SEED{CLEAR_TO 0x50}{FONT_SMALL}10 COINS") },
    { COMPOUND_STRING("CHARCOAL{CLEAR_TO 0x50}{FONT_SMALL}10 COINS") },
    { COMPOUND_STRING("MYSTIC WATER{CLEAR_TO 0x50}{FONT_SMALL}10 COINS") },
    { COMPOUND_STRING("YELLOW FLUTE{CLEAR_TO 0x50}{FONT_SMALL}10 COINS") },
    { sText_NoThanks }
};
